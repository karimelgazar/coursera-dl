...
OPENCOURSE_PROGRAMMING_ASSIGNMENTS_URL = "https://api.coursera.org/api/onDemandProgrammingLearnerAssignments.v1/{course_id}~{element_id}?fields=submissionLearnerSchema"
...
OPENCOURSE_REFERENCES_POLL_URL = "https://api.coursera.org/api/onDemandReferences.v1/?courseId={course_id}&q=courseListed&fields=name%2CshortId%2Cslug%2Ccontent&includes=assets"
OPENCOURSE_REFERENCE_ITEM_URL = "https://api.coursera.org/api/onDemandReferences.v1/?courseId={course_id}&q=shortId&shortId={short_id}&fields=name%2CshortId%2Cslug%2Ccontent&includes=assets"
...
#   "linked": null
# }
OPENCOURSE_ASSET_URL = "https://api.coursera.org/api/assetUrls.v1?ids={ids}"
...
#   "linked": null
# }
OPENCOURSE_ASSETS_URL = "https://api.coursera.org/api/openCourseAssets.v1/{id}"
...
#   "linked": null
# }
OPENCOURSE_API_ASSETS_V1_URL = "https://api.coursera.org/api/assets.v1?ids={id}"
...
#     '&showLockedItems=true'
OPENCOURSE_ONDEMAND_COURSE_MATERIALS_V2 = (
    "https://www.coursera.org/api/onDemandCourseMaterials.v2/?q=slug&slug={class_name}"
...
OPENCOURSE_UNGRADED_WIDGET_SESSIONS_V1_URL = (
    "https://www.coursera.org/api/onDemandWidgetSessions.v1/{user_id}~{course_id}~{element_id}?fields=session,sessionId"
)
...
AUTH_REDIRECT_URL = "https://class.coursera.org/{class_name}/auth/auth_redirector?type=login&subtype=normal"
...
POST_OPENCOURSE_ONDEMAND_EXAM_SESSIONS_GET_STATE = (
    "https://api.coursera.org/api/onDemandExamSessions.v1/{session_id}/actions?includes=gradingAttempts"
)
...
OPENCOURSE_NOTEBOOK_TREE = (
    "https://hub.coursera-notebooks.org/user/{jupId}/api/contents/{path}?type=directory&_={timestamp}"
)
